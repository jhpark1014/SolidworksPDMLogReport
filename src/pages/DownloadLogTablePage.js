...
DownloadLogTablePage.propTypes = {
...
export default function DownloadLogTablePage({ sParam, onSearchType, onSearchDate, onSearchUser, onLogDatas, onTableHead }) {
  ...
  onLogDatas(logDatas);
  onTableHead(getTableHead(searchType));
