              ...
              <TableHead>
                <TableRow>
                  <TableCell align="left" colSpan={2} sx={{ padding: 1, backgroundColor: 'white' }}>                         
                    <Typography variant="subtitle1" noWrap>{sParam.toUpperCase()}, {data.logusername}, {detailLogData.length} 건</Typography>                                      
                  </TableCell>
                  <TableCell align="right" colSpan={2} sx={{ padding: 1, backgroundColor: 'white' }}>                         
                    <Button>
                      <CSVLink 
                        headers={DEATIL_HEAD} 
                        data={detailLogData} 
                        filename={sParam.toUpperCase().concat("_").concat(data.logusername).concat("_").concat(t).concat(".csv")}
                        target="_blank"
                      >
                        EXPORT
                      </CSVLink>   
